...
class BookingModelAdmin(admin.ModelAdmin):
	list_display=['customer_name','booking_start_date','is_approved']
	...
	def email_customers(self,request,queryset):
		...
		self.messaeg_user(request,'emails were send successfully')
	email_customers.short_description='Send email about booing status to customers'
